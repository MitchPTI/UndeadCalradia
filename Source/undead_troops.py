...
ghouls_and_skellies = [
	["ghoul", "Ghoul", "Ghouls", tf_undead|tf_allways_fall_dead, no_scene, 0, fac_undeads,
	[],
	...
	["skeleton_knight", "Skeleton Knight", "Skeleton Knight", tf_undead|tf_allways_fall_dead|tf_mounted|tf_guarantee_all_wo_ranged, no_scene, 0, fac_undeads,
